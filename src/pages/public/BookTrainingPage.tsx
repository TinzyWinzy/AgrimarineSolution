    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center p-4">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600 text-sm">We will confirm the details and propose dates.</p>
    ...
    <div>
      <section className="bg-navy-900 py-12">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-white/70 text-sm">Practical aquaculture training delivered by experienced professionals.</p>
        </div>
      </section>
